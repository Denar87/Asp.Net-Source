...
{
    public partial class SupervisorApproval : System.Web.UI.Page
    {
        ...
        {
            grdRequisition.DataSource = RequisionBll.GetRequisitionToApprove(ReqNo, "Manager");
        ...
        protected void grdRequisition_SelectedIndexChanged(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                {
                    dt = aChallanBll.GetRequisitionTSelecte(Id, "Manager");
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (RequisionBll.Approve(Id, ApproveQty, "Manager"))
                {
