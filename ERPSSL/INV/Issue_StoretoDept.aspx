<%@ Page Title="" Language="C#" MasterPageFile="~/INV/Site.Master" AutoEventWireup="true"
    CodeBehind="Issue_StoretoDept.aspx.cs" Inherits="ERPSSL.INV.Issue_StoretoDept" %>
        ...
        <ContentTemplate>
            <div class="row" style="margin: 0 auto">
                    ...
                    <div class="col-md-12 bg-success">
                        <div class="panel">
                            <div class="panel-heading panel-heading-01">
                                <i class="glyphicon glyphicon-edit icon-padding"></i>Goods Issue Note (GIN) - General Store to Department
                            </div>
                        </div>
                        <center>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <asp:DropDownList ID="ddlStore" Class="form-control" ValidationGroup="Group1" runat="server">
                                        </asp:DropDownList>
                                ...
                                <div class="row" style="padding-top: 5px">
                                    ...
                                    <div class="col-md-8">
                                        <asp:DropDownList ID="ddlOrder" Class="form-control" Enabled="false" placeholder="Order" runat="server" AutoPostBack="True">
                                            <asp:ListItem Value="0" Text="0">--Select Order No.--</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="row" style="padding-top: 5px;">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <asp:TextBox ID="txtDate" CssClass="form-control" ValidationGroup="Group1" runat="server"></asp:TextBox>
                                ...
                                <div class="row" style="padding-top: 5px;">
                                    <div class="col-md-4">
                                        Company<a style="color: red; font-size: 11px">*</a>
                                    </div>
                                    <div class="col-md-8">
                                        <asp:DropDownList ID="ddlSubCompany" Class="form-control" ValidationGroup="Group1" runat="server"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlSubCompany"
                ...
                <div class="panel-heading panel-heading-01">
                    ...
                    <div class="row" style="padding-top: 8px; margin: auto 0;">
                        <div class="col-md-12">
                            <table class="table table-bordered">
                                <tr class="info">
                                    <td>Item Category
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" SetFocusOnError="true" ControlToValidate="ddlItemGroup"
                                     ErrorMessage="*" ValidationGroup="ValPrice"></asp:RequiredFieldValidator>
                                    </td>
                                    <td>Item
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" SetFocusOnError="true" ControlToValidate="ddlItemName"
                                    ErrorMessage="*" ValidationGroup="ValPrice"></asp:RequiredFieldValidator>
                                    </td>
                                    <td>Unit</td>
                                    <td>Balance</td>
                               ...
                               <%-- <thead>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="col-md-12">
                                                <asp:DropDownList ID="ddlItemGroup" AutoPostBack="True" CssClass="form-control" runat="server"
                                                    OnSelectedIndexChanged="ddlItemGroup_SelectedIndexChanged"> </asp:DropDownList>
                                        ...
                                        <td>
                                            <div class="col-md-12">
                                                <asp:TextBox ID="txtIssueQty" placeholder="Iss.Qty" CssClass="form-control" runat="server" AutoPostBack="true" OnTextChanged="txtIssueQty_TextChanged"></asp:TextBox>
                            ...
                            <div class="col-md-1" style="width: 9%">
                                <asp:TextBox ID="txtCPU" Visible="false" placeholder="CPU" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-md-1" style="width: 9%">
                            ...
                            <div class="col-md-1" style="margin: -10px -10px 0 0; float: right">
                                <asp:Button ID="BtnAdd" ValidationGroup="Group1" runat="server" Text="Add" class="btn btn-primary" OnClick="BtnAdd_Click" />
                            </div>
                        ...
                        <div class="col-md-12">
                            <fieldset>
                                ...
                                <asp:GridView ID="grvIssue" runat="server" AutoGenerateColumns="False" Width="100%"
                                     BorderColor="#E3F0FC" CellPadding="5"
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <asp:DropDownList ID="ddlChalanNo" Class="form-control" Visible="false" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlChalanNo_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                            <div class="col-md-1" style="padding-right: 0;">
                                <asp:Button ID="btnSave" ValidationGroup="Group1" runat="server" Text="Issue" CssClass="btn btn-info pull-right" OnClick="btnSave_Click" />
                            </div>
                            <div class="col-md-1">
                ...
                <div class="col-md-12">
                    <rsweb:ReportViewer ID="ReportViewerDo" AsyncRendering="False" interactivedeviceinfos="(Collection)"
