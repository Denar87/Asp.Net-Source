<%@ Page Title="" Language="C#" MasterPageFile="~/INV/Site.Master" AutoEventWireup="true"
    CodeBehind="CompanyType.aspx.cs" Inherits="ERPSSL.INV.CompanyType" %>
            ...
            <div class="row">
                <div class="hm_sec_2_content scrollbar">
                    ...
                    <div class="panel-heading panel-heading-01">
                        <i class="glyphicon glyphicon-edit icon-padding"></i>Company Type Information
                    </div>
                </div>
                        ...
                        <div class="col-md-12" style="margin-top: 10px;">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-4">
                                            Company Type <a style="color: red; font-size: 11px">*</a>
                                        </div>
                                        <div class="col-md-8">
                                            <asp:TextBox ID="txtCopmayType" runat="server" class="form-control"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="txtCopmayType"
                                                Display="Dynamic" ForeColor="Red" SetFocusOnError="True" ErrorMessage="Enter Company Type"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-4">
                                            <asp:HiddenField ID="hdfCompanyTypeID" runat="server" />
                                        </div>
                                        <div class="col-md-8">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <asp:GridView ID="grdCompanyType" runat="server" Width="100%" AutoGenerateColumns="false"
                                        AllowPaging="true" AllowSorting="true" CellPadding="5" BorderColor="#E3F0FC"
                                        BorderStyle="Solid" CssClass="Grid_Border" PageSize="10" OnPageIndexChanging="grdCompanyType_PageIndexChanging">
                                        <AlternatingRowStyle CssClass="Grid_AltRowStyle" />
                                        <Columns>
                                            <asp:TemplateField Visible="False">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblId" runat="server" Text='<%# Eval("CompanyType_Id")%>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
