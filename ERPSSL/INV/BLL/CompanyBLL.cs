...
namespace ERPSSL.INV.BLL
{
    public class CompanyBLL
    {
        ...
        {
            return companyDal.GetStore(OCODE);
        }
        ...
        {
            return companyDal.GetcompanyTypeByCode();
        }

        internal List<Inv_Company> GetcompanyByCode(string CompanyType)
        {
            return companyDal.GetcompanyByCode(CompanyType);
        }
        ...
        {
            return companyDal.GetStorebyStore(OCODE, StoreToCode);
        }

        internal List<Inv_Store> GetStoreCodeByCode(int sId)
        {
            return companyDal.GetStoreCodeByCode(sId);
        }

        internal List<HRM_SubCompany> GetSubCompanyList(string OCode)
        {
            return companyDal.GetSubCompanyList(OCode);
        }
    }
}