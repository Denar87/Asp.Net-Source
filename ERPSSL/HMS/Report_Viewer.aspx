<%@ Page Title="" Language="C#" MasterPageFile="~/HMS/HMS.Master" AutoEventWireup="true" CodeBehind="Report_Viewer.aspx.cs" Inherits="ERPSSL.HMS.Report_Viewer" %>
        ...
        <center>
            ...
            <div class="row">
                ...
                <div style="float: right; padding-right: 110px;">
                    ...
                    <asp:ImageButton ID="btnDload" runat="server" OnClick="btnDload_Click" ImageUrl="~/HMS/Resources/download177.png" Width="32" />
