<%@ Page Title="" Language="C#" MasterPageFile="~/Requisition/Site.Master" AutoEventWireup="true"
    CodeBehind="DeptWise_UpdateStoreRequisition.aspx.cs" Inherits="ERPSSL.Requisition.DeptWise_UpdateStoreRequisition" %>
            ...
            <div class="hm_sec_2_content scrollbar">
                <div class="row">
                    ...
                    <div class="col-md-12" style="text-align: right;">
                        <asp:Button ID="btnBack" CssClass="btn btn-info pull-right" runat="server" Text="Dept Wise Store Requisition List" OnClick="btnBack_Click" />
