<%@ Page Title="" Language="C#" MasterPageFile="~/HRM/Site.Master" AutoEventWireup="true" CodeBehind="ShiftSetupForDepartment.aspx.cs" Inherits="ERPSSL.HRM.ShiftSetupForDepartment" %>
            ...
            <div class="row hm_sec_2_content scrollbar">
                <div class="panel">
                    <div class="panel-heading panel-heading-01">
                        <i class="glyphicon glyphicon-edit icon-padding"></i>Department wise Shift Setup
                    </div>
                </div>
                <center>
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-7">
                                            <asp:DropDownList ID="ddlWeekend1Duty" AutoPostBack="true" OnSelectedIndexChanged="ddlWeekend1Duty_ddlWeekend1Duty"
                                                ...
                                                <asp:ListItem Value="False" Text="------ Select One ------"></asp:ListItem>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-7">
                                            <asp:DropDownList ID="ddlShiftName" AutoPostBack="True" CssClass="form-control"
                                                runat="server">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="ddlShiftName"
