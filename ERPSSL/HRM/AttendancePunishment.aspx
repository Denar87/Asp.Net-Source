<%@ Page Title="" Language="C#" MasterPageFile="~/HRM/Site.Master" AutoEventWireup="true" CodeBehind="AttendancePunishment.aspx.cs" Inherits="ERPSSL.HRM.AttendancePunishment" %>
            ...
            <div class="hm_sec_2_content scrollbar">
                <div class="panel">
                    <div class="panel-heading panel-heading-01">
                        <i class="fa fa-edit fa-fw icon-padding"></i>Attendance Pull Out
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="col-md-4">
                        <fieldset>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-10" style="padding-right: 0px;">
                                    <asp:CheckBox ID="ckIndividualPunishment" AutoPostBack="true" OnCheckedChanged="ckIndividualPunishment_click" runat="server" Text="Individual Employee" />
                                </div>
                            </div>
        ...
        function checkAll(objRef) {
            ...
            <script type="text/javascript">
                ...
                function func(result) {
                    if (result === 'Attendance Punishment Successfull') {
