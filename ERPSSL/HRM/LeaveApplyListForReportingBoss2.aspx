<%@ Page Title="" Language="C#" MasterPageFile="~/HRM/Site.Master" AutoEventWireup="true" CodeBehind="LeaveApplyListForReportingBoss2.aspx.cs" Inherits="ERPSSL.HRM.LeaveApplyListForReportingBoss2" %>
...
<ContentTemplate>
    ...
    <div class="hm_sec_2_content scrollbar">
        ...
        <div class="panel-heading panel-heading-01">
            <i class="fa fa-edit fa-fw icon-padding"></i>Leave Apply List For Reporting Boss 2
        </div>
    </div>
        <div class="col-md-12">
