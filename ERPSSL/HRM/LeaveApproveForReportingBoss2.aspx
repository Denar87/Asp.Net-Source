<%@ Page Title="" Language="C#" MasterPageFile="~/HRM/Site.Master" AutoEventWireup="true" CodeBehind="LeaveApproveForReportingBoss2.aspx.cs" Inherits="ERPSSL.HRM.LeaveApproveForReportingBoss2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div class="hm_sec_2_content scrollbar">
        ...
        <div class="panel-heading panel-heading-01">
            <i class="fa fa-edit fa-fw icon-padding"></i>Leave Approve For Reporting Boss 2
        </div>
    </div>
    <div class="col-md-12">
