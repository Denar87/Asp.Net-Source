            ...
            try
            {
                ...
                if (rdbDailyAttendance.Checked)
                {
                    if (fromDate == toDate)
                    {
                        ...
                        {
                            empAtendance = aAttendance_RPT_Bll.GetAttendanceAllEmpForAllBySubSection(Convert.ToInt32(ddlSubSections.SelectedValue), Convert.ToInt32(ddlSection.SelectedValue), Convert.ToInt32(ddlDept1.SelectedValue), Convert.ToInt32(ddlOffice1.SelectedValue), Convert.ToInt32(ddlRegion1.SelectedValue), fromDate, toDate).ToList();
                        ...
                        {
                            empAtendance = aAttendance_RPT_Bll.GetAttendanceAllEmpForAllBySection(Convert.ToInt32(ddlSection.SelectedValue), Convert.ToInt32(ddlDept1.SelectedValue), Convert.ToInt32(ddlOffice1.SelectedValue), Convert.ToInt32(ddlRegion1.SelectedValue), fromDate, toDate).ToList();
                            if (empAtendance.Count > 0)
                            {
                                Session["rptDs"] = "HRM_RPT_AttendanceAllEmpDailyByDeptDS";
                                Session["rptDt"] = empAtendance;
                        ...
                        {
                            empAtendance = aAttendance_RPT_Bll.GetAttendanceAllEmpForAllByDept(Convert.ToInt32(ddlDept1.SelectedValue), Convert.ToInt32(ddlOffice1.SelectedValue), Convert.ToInt32(ddlRegion1.SelectedValue), fromDate, toDate).ToList();
                            if (empAtendance.Count > 0)
                            {
                                Session["rptDs"] = "HRM_RPT_AttendanceAllEmpDailyByDeptDS";
                                Session["rptDt"] = empAtendance;
                ...
                #region daily Present report
                else if (rdbPresentReport.Checked == true)
                {
                    if (fromDate == toDate)
                    {
                        if (ddlRegion1.SelectedItem.Text != "--Select--" && ddlOffice1.SelectedItem.Text != "--Select--" && ddlDept1.SelectedItem.Text != "--Select--" && ddlSection.SelectedItem.Text != "--Select--" && ddlSubSections.SelectedItem.Text != "--Select--")
                        {
                            empAtendance = aAttendance_RPT_Bll.GetPresentAllEmpForAllBySubSection(Convert.ToInt32(ddlSubSections.SelectedValue), Convert.ToInt32(ddlSection.SelectedValue), Convert.ToInt32(ddlDept1.SelectedValue), Convert.ToInt32(ddlOffice1.SelectedValue), Convert.ToInt32(ddlRegion1.SelectedValue), "P", fromDate, toDate).ToList();
                            if (empAtendance.Count > 0)
                            {
                                Session["rptDs"] = "HRM_RPT_AttendanceAllEmpDailyByDeptDS";
                                Session["rptDt"] = empAtendance;
                                Session["rptFile"] = "/HRM/reports/HRM_RPT_DailyPresentBySubSection.rdlc";
                                Session["rptTitle"] = "Daily Present Report";
                                Response.Redirect("Report_Viewer.aspx");
                            }
                            else
                            {
                        ...
                        {
                            empAtendance = aAttendance_RPT_Bll.GetPresentAllEmpForAllBySection(Convert.ToInt32(ddlSection.SelectedValue), Convert.ToInt32(ddlDept1.SelectedValue), Convert.ToInt32(ddlOffice1.SelectedValue), Convert.ToInt32(ddlRegion1.SelectedValue), "P", fromDate, toDate).ToList();
                            if (empAtendance.Count > 0)
                            {
                                Session["rptDs"] = "HRM_RPT_AttendanceAllEmpDailyByDeptDS";
                                Session["rptDt"] = empAtendance;
                                Session["rptFile"] = "/HRM/reports/HRM_RPT_DailyPresentBySection.rdlc";
                                Session["rptTitle"] = "Daily Present Report";
                                Response.Redirect("Report_Viewer.aspx");
                            }
                            else
                        ...
                        {
                            empAtendance = aAttendance_RPT_Bll.GetPresentAllEmpForAllByDept(Convert.ToInt32(ddlDept1.SelectedValue), Convert.ToInt32(ddlOffice1.SelectedValue), Convert.ToInt32(ddlRegion1.SelectedValue), "P", fromDate, toDate).ToList();
                            if (empAtendance.Count > 0)
                            {
                                Session["rptDs"] = "HRM_RPT_AttendanceAllEmpDailyByDeptDS";
                                Session["rptDt"] = empAtendance;
                                Session["rptFile"] = "/HRM/reports/HRM_RPT_DailyPresentByDept.rdlc";
                                Session["rptTitle"] = "Daily Present Report ";
                                Response.Redirect("Report_Viewer.aspx");
                            }
                            else
                        ...
                        {
                            empAtendance = aAttendance_RPT_Bll.GetPresentAllEmpForAllByByOffice(Convert.ToInt32(ddlOffice1.SelectedValue), Convert.ToInt32(ddlRegion1.SelectedValue), "P", fromDate, toDate).ToList();
                            if (empAtendance.Count > 0)
                            {
                                Session["rptDs"] = "HRM_RPT_AttendanceAllEmpDailyByDeptDS";
                                Session["rptDt"] = empAtendance;
                                Session["rptFile"] = "/HRM/reports/HRM_RPT_DailyPresentByOffice.rdlc";
                                Session["rptTitle"] = "Daily Present Report ";
                                Response.Redirect("Report_Viewer.aspx");
                            }
                            else
                        ...
                        {
                            empAtendance = aAttendance_RPT_Bll.GetPresentAllEmpForAll("P", fromDate, toDate).ToList();
                            if (empAtendance.Count > 0)
                            {
                                Session["rptDs"] = "HRM_RPT_AttendanceAllEmpDailyByDeptDS";
                                Session["rptDt"] = empAtendance;
                                Session["rptFile"] = "/HRM/reports/HRM_RPT_DailyPresentAll.rdlc";
                                Session["rptTitle"] = "Daily Present Report ";
                                Response.Redirect("Report_Viewer.aspx");
                            }
                            else
                ...
                else if (rdbMonthlyAttendanceEmpwise.Checked)
                {
                    ...
                    //if (rdbAll.Checked)
                    {
                        ...
                        if (empAtendance.Count > 0)
                        {
                            ...
                            Session["rptDt"] = empAtendance;
                            Session["rptFile"] = "/HRM/reports/HRM_RPT_AttendanceEmpwise(Multiple).rdlc";
