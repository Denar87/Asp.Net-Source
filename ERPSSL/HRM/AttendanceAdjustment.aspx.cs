    ...
    public partial class AttendanceAdjustment : System.Web.UI.Page
    {
        ...
        private void GerRegion1List()
        {
            ...
            catch (Exception ex)
            {
                ...
                //LogController<AttendanceAdjustment>.SetLog(ex, EID);
        ...
        protected void btn_Confirm_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ckAttendanceAdjustment.Checked)  //individual
                {
                    if (txtbxEID.Text == "")
                    {
                    ...
                    _attendance.Edit_User = userId;
                    _attendance.Edit_Date = EDIT_DATE;
                    _attendance.OCode = OCODE;
                    ...
                    if (attendances.Count > 0)
                    {
                        ...
                        if (lstEmpAttendnace.Count > 0)
                        {
                            ...
                            int result = _attendancebll.DeleteAttendance(attendances, PunishedBy);
                            ...
                            if (result == 1)
                            {
                                ...
                                ClearUI();
                                ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "text", "func('Attendance Adjustment Successfull')", true);
                            }
                        }
                        else
                        {
        ...
        protected void ckAttendanceAdjustment_click(object sender, EventArgs e)
        {
            try
            {
                if (ckAttendanceAdjustment.Checked)
                {
                    txtbxEID.Text = "";
