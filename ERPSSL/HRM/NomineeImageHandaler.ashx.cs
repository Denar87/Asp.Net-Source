...
{
    /// <summary>
    /// Summary description for NomineeImageHandaler
    /// </summary>
    public class NomineeImageHandaler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            SqlCommand cmd = new SqlCommand("GET_Nominee_Image_SP", Conn);
            ...
            try
            {
                if (sqlReader.Read())
                {
                    byte[] imageByte = sqlReader["Nomine_Photo"] as byte[] ?? null;
