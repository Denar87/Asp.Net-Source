...
{
    public partial class LeaveApplyListForReportingBoss2 : System.Web.UI.Page
    {
        ...
        private void getLeaveInfoForApprove()
        {
            ...
            if (eid != null)
            {
                ...
                List<LeaveInfo> leaveinfoes = leaveBllobj.getLeaveInfoForReportingBoss2(eid, currentYear, OCODE).ToList();
        ...
        protected void btnaprove_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (lblLeaveCode != null && lblEidID != null)
                {
                    ...
                    Response.Redirect("LeaveApproveForReportingBoss2.aspx");
                }
            }
            catch (Exception ex)
            {
