...
{
    /// <summary>
    /// Summary description for EmployeeSignature
    /// </summary>
    public class EmployeeSignature : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            SqlCommand cmd = new SqlCommand("GET_EMPLOYEE_Signature_SP", Conn);
            ...
            try
            {
                if (sqlReader.Read())
                {
                    byte[] imageByte = sqlReader["EMP_Singnature"] as byte[] ?? null;
