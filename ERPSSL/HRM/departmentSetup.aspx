<%@ Page Title="" Language="C#" MasterPageFile="~/HRM/Site.Master" AutoEventWireup="true"
    CodeBehind="departmentSetup.aspx.cs" Inherits="ERPSSL.HRM.departmentSetup" %>
                          ...
                          <%--  <asp:Label ID="lblOfficeCode" runat="server"></asp:Label>
                            ...
                            <div class="col-md-12" style="padding-left:0px;">
                                            ...
                                            <div class="col-md-7" style="padding-left:0px;">
                                                ...
                                                <asp:TextBox ID="txtoffice" runat="server" Width="90px" ReadOnly="true" class="form-control"></asp:TextBox>

                                            </div>

                                            <div class="col-md-5" style="padding-left:0px;">

                                                <asp:TextBox ID="txtbxDepartmentCode" runat="server" Width="90px" class="form-control"></asp:TextBox>
                                            </div>
