<%@ Page Title="" Language="C#" MasterPageFile="~/HRM/Site.Master" AutoEventWireup="true" CodeBehind="AttendanceReports.aspx.cs" Inherits="ERPSSL.HRM.AttendanceReports" %>
                            ...
                            <div class="row radio_input00">
                                <fieldset>
                                    ...
                                    <div style="padding-top: 0px">
                                        <asp:RadioButton ID="rdbDailyAttendance" runat="server" Text="Attendance Report" GroupName="rpt_Attend" Checked="true" /><br />
                                        <asp:RadioButton ID="rdbPresentReport" runat="server" Text="Present Report" GroupName="rpt_Attend" /><br />
                                        <asp:RadioButton ID="rdbDailyAbsentReport" runat="server" Text="Absent Report" GroupName="rpt_Attend" /><br />
                                ...
                                <%-- <fieldset>
                                    ...
                                    <div style="padding-top: 10px">
                                        <asp:RadioButton ID="rdbEmpwiseAll" runat="server" Text="Attendence Report" GroupName="rpt_Attend" />
                                        <br />
