<%@ Page Title="" Language="C#" MasterPageFile="~/HRM/Site.Master" AutoEventWireup="true" CodeBehind="AttendanceAdjustment.aspx.cs" Inherits="ERPSSL.HRM.AttendanceAdjustment" %>
        ...
        <ContentTemplate>
            ...
            <div class="hm_sec_2_content scrollbar">
                <div class="panel">
                    <div class="panel-heading panel-heading-01">
                        <i class="fa fa-edit fa-fw icon-padding"></i>Attendance Adjustment
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="col-md-4">
                        <fieldset>
                            <legend style="line-height: 0px;"><span style="background: #fff">Select for Process</span></legend>
                            <div class="col-md-12">
                                <div class="col-md-2" style="padding-left: 0px;">
                                </div>
                                <div class="col-md-10" style="padding-right: 0px;">
                                    <asp:CheckBox ID="ckAttendanceAdjustment" AutoPostBack="true" OnCheckedChanged="ckAttendanceAdjustment_click" runat="server" Text="Individual Employee" />
                                </div>
                            </div>
                    ...
                    <div class="col-md-8" style="margin: 12px 0 10px 0; overflow-x: hidden; overflow-y: auto; max-height: 400px; height: auto">
                        ...
                        <asp:GridView ID="grdview" runat="server" AutoGenerateColumns="False" Width="100%"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="DATE_JOINED" DataFormatString="{0:dd-MMM-yyyy}" HeaderText="Attendnace Date">
            ...
            <script type="text/javascript">
                ...
                function func(result) {
                    if (result === 'Attendance Adjustment Successfull') {
