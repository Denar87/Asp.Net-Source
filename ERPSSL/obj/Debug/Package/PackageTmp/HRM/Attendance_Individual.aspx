<%@ Page Title="Attendance Individual" Language="C#" MasterPageFile="~/HRM/Site.Master" AutoEventWireup="true"
    CodeBehind="Attendance_Individual.aspx.cs" Inherits="ERPSSL.HRM.Attendance_Individual" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
                ...
                <div class="hm_sec_2_content scrollbar">
                    <div class="panel">
                        <div class="panel-heading panel-heading-01">
                            <i class="fa fa-edit fa-fw icon-padding"></i>Individual Attendance Register
                        </div>
                    </div>
                    ...
                    <fieldset>
                        ...
                        <legend style="line-height: 5px;"><span style="background: #fff">Employee Attendance Details</span></legend>
                        <div class="col-md-12">
                            <div class="col-md-5">
                                <div class="row">
                                    <div class="col-md-12">
    ...
    <script type="text/javascript">
        ...
        function func(result) {
            ...
            if (result === 'Attendance Recorded Successfully') {
