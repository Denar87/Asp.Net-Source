<%@ Page Title="" Language="C#" MasterPageFile="~/Accounting/Site.Master" AutoEventWireup="true"
    CodeBehind="IncomeStatement.aspx.cs" Inherits="ERPSSL.Accounting.UI_Reporting.IncomeStatement" %>
                    ...
                    <div class="widget-box">
                        <div class="widget-header">
                            <h5 class="widget-title bigger lighter">
                                <i class="ace-icon fa fa-table"></i>Income Statement
                            </h5>
                            ...
                            <div class="buttonPanel">
                                ...
                                <asp:ImageButton ID="btnPrint" runat="server" ImageUrl="~/Accounting/Resources/png_icon_set/print49.png"
                                    Width="32px" ValidationGroup="validation" OnClick="btnPrint_Click" />
                            </div>
                        </div>
                        <div class="widget-body">
                            <div class="widget-main no-padding">
                                ...
                                <div style="position: relative">
                                    <ul class="bal_style">
                                        <li>
                                            <asp:Label ID="lblTotalIncome" runat="server"></asp:Label></li>
                                        <li>
                                            <asp:Label ID="lblTotalExpense" runat="server"></asp:Label></li>
                                        <li>
                                            <asp:Label ID="lblProfit" runat="server"></asp:Label></li>
                                    </ul>
                                ...
                                <div class="row-fluid" style="height: 410px; overflow-x: hidden; overflow-y: scroll; margin-top: 10px; padding-top: 10px; padding-bottom: 10px; border-top: 1px solid #eee;">
                                    <asp:GridView ID="dtg_list" runat="server" EmptyDataText="No Records Found!" AllowPaging="False"
                                        ...
                                        CellPadding="1" OnRowDataBound="dtg_list_RowDataBound">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Ledger_Total" HeaderText="Dr." HeaderStyle-HorizontalAlign="Right"
