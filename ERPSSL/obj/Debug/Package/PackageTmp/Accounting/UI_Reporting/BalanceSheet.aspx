<%@ Page Title="" Language="C#" MasterPageFile="~/Accounting/Site.Master" AutoEventWireup="true"
    CodeBehind="BalanceSheet.aspx.cs" Inherits="ERPSSL.Accounting.UI_Reporting.BalanceSheet" %>
                    ...
                    <div class="widget-box">
                        <div class="widget-header">
                            <h5 class="widget-title bigger lighter">
                                <i class="ace-icon fa fa-table"></i>Balance Sheet
                            </h5>
                        ...
                        <div class="widget-body">
                            <div class="widget-main no-padding">
                                ...
                                <div style="position: relative">
                                    <ul class="bal_style">
                                        <li>
                                            <asp:Label ID="lblTotalAsset" runat="server"></asp:Label></li>
                                        <li>
                                            <asp:Label ID="lblTotalCapital" runat="server"></asp:Label></li>
                                    </ul>
                                ...
                                <div class="row-fluid" style="height: 410px; overflow-x: hidden; overflow-y: scroll; margin-top: 10px; padding-top: 10px; padding-bottom: 10px; border-top: 1px solid #eee;">
                                    <asp:GridView ID="dtg_list" runat="server" EmptyDataText="No Records Found!" AllowPaging="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Ledger_Total" HeaderText="Balance" HeaderStyle-HorizontalAlign="Right"
