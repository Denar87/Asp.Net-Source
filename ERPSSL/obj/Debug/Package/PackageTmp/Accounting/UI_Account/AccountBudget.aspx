<%@ Page Title="" Language="C#" MasterPageFile="~/Accounting/Site.Master" AutoEventWireup="true"
    CodeBehind="AccountBudget.aspx.cs" Inherits="ERPSSL.Accounting.UI_Account.AccountBudget" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <div class="widget-box">
                        <div class="widget-header">
                            <h5 class="widget-title bigger lighter">
                                <i class="ace-icon fa fa-table"></i>Budget Creation
                            </h5>
