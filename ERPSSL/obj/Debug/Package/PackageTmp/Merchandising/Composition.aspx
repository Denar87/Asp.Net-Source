<%@ Page Title="" Language="C#" MasterPageFile="~/Merchandising/Merchandising.Master" AutoEventWireup="true" CodeBehind="Composition.aspx.cs" Inherits="ERPSSL.Merchandising.Composition" %>
                ...
                <div class="hm_sec_2_content scrollbar">
                    <div class="panel">
                        <div class="panel-heading panel-heading-01">
                            <i class="fa fa-edit fa-fw icon-padding"></i>Composition
                        </div>
                    </div>
                    <div class="row" style="margin: auto 0;">
                        ...
                        <div class="col-md-5" style="margin: auto 0;">
                            <div class="row" style="padding-top: 5px;">
                                ...
                                <div class="col-md-7">
                                    <asp:TextBox ID="CompositionTextBox" runat="server" placeholder="Composition" class="form-control"></asp:TextBox>
                                </div>    
                        ...
                        <asp:HiddenField ID="compositionHiddenField" runat="server" />
                        <div class="col-md-7" style="padding-top: 5px;">
                            <asp:GridView ID="CompositionInfo" runat="server" AutoGenerateColumns="False" Width="100%"
