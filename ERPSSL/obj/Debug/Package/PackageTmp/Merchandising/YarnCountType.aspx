<%@ Page Title="" Language="C#" MasterPageFile="~/Merchandising/Merchandising.Master" AutoEventWireup="true" CodeBehind="YarnCountType.aspx.cs" Inherits="ERPSSL.Merchandising.YarnCountType" %>
                ...
                <div class="hm_sec_2_content scrollbar">
                    <div class="panel">
                        <div class="panel-heading panel-heading-01">
                            <i class="fa fa-edit fa-fw icon-padding"></i>Yarn Count Type
                        </div>
                    </div>
                    <div class="row" style="margin: auto 0;">
                        ...
                        <div class="col-md-5" style="margin: auto 0;">
                            <div class="row" style="padding-top: 5px;">
                                ...
                                <div class="col-md-7">
                                    <asp:TextBox ID="yarnCountTypeTextBox" runat="server" placeholder="Construction Type" class="form-control"></asp:TextBox>
                                </div>    
                        ...
                        <asp:HiddenField ID="yarncontTypeHiddenField" runat="server" />
                        <div class="col-md-7" style="padding-top: 5px;">
                            <asp:GridView ID="yarnCountTypeInfo" runat="server" AutoGenerateColumns="False" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="YarnCountType" HeaderText="Yarn Count Type" />
