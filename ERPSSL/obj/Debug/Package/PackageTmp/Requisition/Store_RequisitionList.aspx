<%@ Page Title="" Language="C#" MasterPageFile="~/INV/Site.Master" AutoEventWireup="true"
    CodeBehind="Store_RequisitionList.aspx.cs" Inherits="ERPSSL.INV.Store_RequisitionList" %>
            ...
            <div class="row">
                ...
                <div class="hm_sec_2_content scrollbar">
                    ...
                    <div class="panel-heading panel-heading-01">
                        <i class="glyphicon glyphicon-edit icon-padding"></i>Store Requisition List 
                    </div>
                </div>
                    ...
                    <div class="col-md-9" >
                              ...
                              <fieldset >
                                  <legend style="line-height: 5px;"><span style="background: #fff">Select Date</span></legend>
                             <div class="col-md-5">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="row ">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <asp:Button ID="BtnSave" runat="server" Text="Edit" Style="margin-right: 18px;float:right;" ValidationGroup="Group1"
