<%@ Page Title="" Language="C#" MasterPageFile="~/Requisition/Site.Master" AutoEventWireup="true"
    CodeBehind="PurchaseRequisition_ManagementApproval.aspx.cs" Inherits="ERPSSL.Requisition.PurchaseRequisition_ManagementApproval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div class="row">
        <div class="panel">
            <div class="panel-heading panel-heading-01">
                <i class="glyphicon glyphicon-edit icon-padding"></i>Purchase Requisition Management Approval
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <fieldset>
                        ...
                        <asp:GridView ID="grvReqItemList" runat="server" AutoGenerateColumns="False" Width="100%" DataKeyNames="ReqNo"  ShowFooter="true"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField Visible="true" HeaderText="Total App. Qty" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <asp:Label ID="lblTotalAppQty" runat="server" Text='<%# Eval("Final_App_Qty")%>' />
                                    </ItemTemplate>

                                    <ItemStyle HorizontalAlign="Center" Width="10%"></ItemStyle>
                                </asp:TemplateField>
                                <asp:BoundField DataField="Final_App_Qty" HeaderText="Total App. Qty" Visible="false" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%">
                                    <ItemStyle HorizontalAlign="Center" Width="10%"></ItemStyle>
                                </asp:BoundField>
                                <asp:BoundField DataField="HeadApproveQty" HeaderText="Req. Qty" Visible="true" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%">
                                    <ItemStyle HorizontalAlign="Center" Width="10%"></ItemStyle>
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="App. Qty" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtApproveQty" runat="server" Text='<%# Eval("ManagementAppQty")%>'  OnTextChanged="txtApproveQty_Changed" AutoPostBack="true" Width="100%" ToolTip="Enter Approve Quantity" Style="text-align: center"></asp:TextBox>
                                    </ItemTemplate>
                    ...
                    <div class="row ">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <asp:FileUpload ID="ReqFileUpload" CssClass="form-control" runat="server" />
                            </div>
                            <div class="col-md-4">
                                <asp:Button ID="btnPrint" runat="server" Style="margin-top: 6px; margin-right: 0px;" Text="Print" CssClass="btn btn-warning"
                                    OnClick="btnPrint_Click" />
                                <asp:Button ID="BtnSave" runat="server" Text="Proccess" Style="margin-top: 6px; margin-right: 20px;" ValidationGroup="Group1"
    ...
    <script type="text/javascript">
        ...
        function func(result) {
            if (result === 'No purchase requisition found') {
