<%@ Page Title="" Language="C#" MasterPageFile="~/Requisition/Site.Master" AutoEventWireup="true"
    CodeBehind="PurchaseRequisition_SupervisorApproval.aspx.cs" Inherits="ERPSSL.Requisition.PurchaseRequisition_SupervisorApproval" %>
            ...
            <div class="hm_sec_2_content scrollbar">
                <div class="panel">
                    <div class="panel-heading panel-heading-01">
                        <i class="glyphicon glyphicon-edit icon-padding"></i>Purchase Requisition Supervisor-1 Approval
                    </div>
                </div>
              ...
              <%--  <br />
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <fieldset>
                            <%--<legend style="line-height: 0; margin-bottom: 0"><span style="background: #fff">Requisition Item List</span></legend>--%>
                            <asp:GridView ID="grvReqItemList" runat="server" AutoGenerateColumns="False" Width="100%" DataKeyNames="ReqNo"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="StyleAndSize" HeaderText="Description" ItemStyle-Width="12%">
                                        <ItemStyle Width="12%" CssClass="Grid_Border" />
                                    </asp:BoundField>
