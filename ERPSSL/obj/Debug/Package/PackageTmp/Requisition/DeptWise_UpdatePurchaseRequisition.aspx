<%@ Page Title="" Language="C#" MasterPageFile="~/Requisition/Site.Master" AutoEventWireup="true"
    CodeBehind="DeptWise_UpdatePurchaseRequisition.aspx.cs" Inherits="ERPSSL.Requisition.DeptWise_UpdatePurchaseRequisition" %>
                ...
                <div class="hm_sec_2_content scrollbar">
                    ...
                    <div class="col-md-12">
                        <fieldset style="background: #ccc;">
                            ...
                            <div class="col-md-1">
                                <asp:TextBox ID="txtQuantity" CssClass="form-control" runat="server" Placeholder="Enter Req. Qty" Width="144%"></asp:TextBox>
                    ...
                    <div class="col-md-12" style="text-align:right;">
                        <asp:Button ID="btnBack" CssClass="btn btn-info pull-right"  runat="server" Text="Dept Wise Purchase Requisition List" OnClick="btnBack_Click" />
