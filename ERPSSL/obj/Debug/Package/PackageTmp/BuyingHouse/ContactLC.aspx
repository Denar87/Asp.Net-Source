<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactLC.aspx.cs" Inherits="ERPSSL.BuyingHouse.ContactLC" MasterPageFile="~/BuyingHouse/BuyingSite.Master" %>
                ...
                <div class="hm_sec_2_content scrollbar">
                    <div class="panel">
                        <div class="panel-heading panel-heading-01">
                            <i class="glyphicon glyphicon-edit icon-padding"></i>Contact LC
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row" style="padding-top: 5px">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:TextBox ID="txtSeason" runat="server" placeholder="Season" class="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="padding-top: 5px">
