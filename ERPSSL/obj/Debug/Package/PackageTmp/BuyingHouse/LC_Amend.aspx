<%@ Page Title="" Language="C#" MasterPageFile="~/BuyingHouse/BuyingSite.Master" AutoEventWireup="true" CodeBehind="LC_Amend.aspx.cs" Inherits="ERPSSL.BuyingHouse.LC_Amend" %>
                ...
                <div class="hm_sec_2_content scrollbar">
                    <div class="panel">
                        <div class="panel-heading panel-heading-01">
                            <i class="fa fa-edit fa-fw icon-padding"></i>LC / Contact Amend
                        </div>
                    </div>
                    <div class="row" style="margin: auto 0;">
                        ...
                        <div class="col-md-7" style="margin: auto 0; background-color: #a7c5a7; padding-bottom: 10px;">
                            <div class="col-md-4" style="margin: auto 0;">
                                ...
                                <div class="row" style="padding-top: 5px;">
                                    Date of Expiry
                                   <asp:TextBox ID="txtDateofExpiry" runat="server" Enabled="false" placeholder="MM/dd/yyyy" class="form-control"></asp:TextBox>
                                ...
                                <div class="row" style="padding-top: 5px;">
                                    LC Issuing Bank
                                    <asp:TextBox ID="txtIssueBank" Width="267%" Enabled="false" runat="server" placeholder="" class="form-control"></asp:TextBox>
