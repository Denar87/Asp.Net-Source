<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/Marketing.Master" AutoEventWireup="true" CodeBehind="WorkOrderSatus.aspx.cs" Inherits="ERPSSL.Marketing.WorkOrderSatus" %>
        ...
        <div class="hm_sec_2_content scrollbar">
            <div class="panel">
                <div class="panel-heading panel-heading-01">
                    <i class="glyphicon glyphicon-edit icon-padding"></i>Work Order Status
                </div>
            </div>
            ...
            <div class="col-md-12">
                    ...
                    <fieldset>
                        <legend style="line-height: 0px; padding-top: 5px;"><span style="background: #fff">Work Order Status List</span></legend>
                            ...
                            <asp:GridView ID="grdorder" runat="server" AutoGenerateColumns="False" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <%--<asp:TemplateField Visible="False">
                                      ...
                                      <asp:TemplateField Visible="False">
                                        <ItemTemplate>
                                            <asp:Label ID="lblOrder_No" runat="server" Text='<%# Eval("WoID")%>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:BoundField DataField="WorkOrderDate" HeaderText="Work Order Date">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
