<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/Marketing.Master" AutoEventWireup="true" CodeBehind="ClientwiseCollectionReport.aspx.cs" Inherits="ERPSSL.Marketing.ClientwiseCollectionReport" %>
                ...
                <div class="hm_sec_2_content scrollbar">
                    <div class="panel">
                        <div class="panel-heading panel-heading-01">
                            <i class="glyphicon glyphicon-edit icon-padding"></i>Client Wise Collection History
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                     <div class="col-md-12">
                                        <asp:Label ID="lblMarketingPersonOrStage" runat="server">Select Client Name</asp:Label>
                                        <asp:DropDownList ID="clientNameDropDownList" AppendDataBoundItems="True" CssClass="form-control" runat="server">
                                        </asp:DropDownList>
                                    </div>  
                                </div>
                    ...
                    <div class="col-md-12">
                        <%-- Report Viewer --%>
                        <rsweb:ReportViewer ID="clientwiseTransactioonReportViewer" runat="server" style="width:1050px;"></rsweb:ReportViewer>
                    </div>
                </div>
