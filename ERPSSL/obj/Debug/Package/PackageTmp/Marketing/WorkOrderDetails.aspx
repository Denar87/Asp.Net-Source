<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/Marketing.Master" AutoEventWireup="true" CodeBehind="WorkOrderDetails.aspx.cs" Inherits="ERPSSL.Marketing.WorkOrderDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
                ...
                <div class="hm_sec_2_content scrollbar">
                    <div class="panel">
                        <div class="panel-heading panel-heading-01">
                            <i class="fa fa-edit fa-fw icon-padding"></i>Work Order Details
                        </div>
                    </div>
                        ...
                        <div class="col-md-7" style="margin: auto 0; background-color: #a7c5a7; padding-bottom: 10px;">
                            <div class="col-md-4" style="margin: auto 0;">
                                <div class="row" style="padding-top: 5px;">
                                    ...
                                    <asp:TextBox ID="workOrderDateTextBox" runat="server" placeholder="MM/dd/yyyy" class="form-control"></asp:TextBox>
                                ...
                                <div class="row" style="padding-top: 5px;">
                                    ...
                                    <asp:TextBox ID="workCompletionPeriodTextBox" runat="server" placeholder="Work completion Period" class="form-control"></asp:TextBox>
                                ...
                                <div class="row" style="padding-top: 5px;">
                                    ...
                                    <asp:TextBox ID="proposedAmountTextBox" runat="server" placeholder="Work Order Amount" AutoPostBack="true" class="form-control" OnTextChanged="proposedAmountTextBox_TextChanged"></asp:TextBox>
                                ...
                                <div class="row" style="padding-top: 5px;">
                                    ...
                                    <asp:TextBox ID="signingAmountTextBox" runat="server" placeholder="Collection Amount" AutoPostBack="true" class="form-control" OnTextChanged="signingAmountTextBox_TextChanged"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorSigningAmount" runat="server" ErrorMessage="Input Collection Amount" ValidationGroup="marketing" ControlToValidate="signingAmountTextBox" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                                <div class="row" style="padding-top: 5px;">
                                    Remaining Amount
                            ...
                            <div class="col-md-4" style="margin: auto 0;">
                                ...
                                <div class="row" style="padding-top: 5px;">
                                    ...
                                    <asp:TextBox ID="developmentDepartmentTextBox" runat="server" placeholder="Development Department" class="form-control"></asp:TextBox>
                                </div>

                                <div class="row" style="padding-top: 5px;">
                                    Warranty Period (Month) <span style="color: red; font-size: 11px">*</span>
                                    <asp:TextBox ID="warrentyPeriodTextBox" runat="server" placeholder="Warranty Period" class="form-control" onkeypress="return onlyNumbers(event)" OnTextChanged="warrentyPeriodTextBox_TextChanged" AutoPostBack="True"></asp:TextBox>
                                </div>
                                <div class="row" style="padding-top: 5px;">
                                    AMC Date
                                    <asp:TextBox ID="amcDateTextBox" runat="server" placeholder="MM/dd/yyyy" class="form-control"></asp:TextBox>
                                ...
                                <div class="row" style="padding-top: 5px;">
                                    Handover Status
                                    <asp:DropDownList ID="handoverStatusDropDownList" runat="server" class="form-control">
                    ...
                    <div class="row">
                         ...
                         <div class="col-md-12" style="padding-top:15px;padding-bottom:10px;">
                                <asp:TextBox ID="searchTextBox2" placeholder="Search By Client Name" AutoPostBack="true" CssClass="form-control" runat="server" OnTextChanged="searchTextBox2_TextChanged"></asp:TextBox>
                                <cc1:AutoCompleteExtender ServiceMethod="SearchClientName2"
                                    MinimumPrefixLength="1"
                                    CompletionInterval="100" EnableCaching="False"
                                    TargetControlID="searchTextBox2"
    ...
    <script type="text/javascript">
        function func(result) {
            ...
            else if (result === 'Input Warranty Period (Months)') {
                toastr.error(result);
            }
            else
                toastr.error(result);
