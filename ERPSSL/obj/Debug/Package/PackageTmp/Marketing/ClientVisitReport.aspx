<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/Marketing.Master" AutoEventWireup="true" CodeBehind="ClientVisitReport.aspx.cs" Inherits="ERPSSL.Marketing.ClientVisitReport" %>
                ...
                <div class="hm_sec_2_content scrollbar">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset>
                                    <legend style="line-height: 0;"><span style="background: #fff">Select Report Category</span></legend>
                                    <asp:RadioButton ID="clientRadioButton" runat="server" Text="Client List" GroupName="rpt_Prod" AutoPostBack="True" Checked="True" OnCheckedChanged="clientRadioButton_CheckedChanged"/><br />
                                    <asp:RadioButton ID="MarketingPersonRadioButton" runat="server" OnCheckedChanged="MarketingPersonRadioButton_CheckedChanged" Text="Marketing Person" GroupName="rpt_Prod" AutoPostBack="True" /><br />
                                    <asp:RadioButton ID="stageRadioButton" runat="server" OnCheckedChanged="stageRadioButton_CheckedChanged" Text="Stage" GroupName="rpt_Prod" AutoPostBack="True" /><br />
                                </fieldset>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <rsweb:ReportViewer ID="ClientVisitReportViewer" runat="server" Width="800px" style="width:1050px;"></rsweb:ReportViewer>
                    </div>
                </div>
