<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/Marketing.Master" AutoEventWireup="true" CodeBehind="CollectionReport.aspx.cs" Inherits="ERPSSL.Marketing.CollectionReport" %>
        ...
        <ContentTemplate>
            ...
            <div class="row">
                <div class="hm_sec_2_content scrollbar">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <asp:RadioButton ID="clientRadioButton" runat="server" Text="Client List" GroupName="rpt_Prod" AutoPostBack="True" Checked="True" /><br />
                                    <asp:RadioButton ID="MarketingPersonRadioButton" runat="server"  Text="Marketing Person" GroupName="rpt_Prod" AutoPostBack="True" /><br />
                                    <asp:RadioButton ID="stageRadioButton" runat="server"  Text="Stage" GroupName="rpt_Prod" AutoPostBack="True" /><br />
                                </fieldset>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <%-- Report Viewer Here --%>
                        <rsweb:ReportViewer ID="collectionByClientReportViewer" runat="server" Width="1100px"></rsweb:ReportViewer>
                    </div>
                </div>
