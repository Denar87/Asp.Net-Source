<%@ Page Title="" Language="C#" MasterPageFile="~/PAYROLL/Site.Master" AutoEventWireup="true" CodeBehind="PayrollRPT_Compliance.aspx.cs" Inherits="ERPSSL.PAYROLL.PayrollRPT_Compliance" %>
                        ...
                        <div class="col-md-6">
                            <fieldset>
                                ...
                                <div style="padding-top: 0px">
                                    ...
                                    <asp:RadioButton ID="rdSalaryandOTCompliance" runat="server" Text="Salary & OT" GroupName="rpt_Attend" />
                                    <br />        
                                    <asp:RadioButton ID="rdSalaryandOTSheetByCash" runat="server" Text="Salary & OT(Cash)" GroupName="rpt_Attend" />
                                    <br />
                                    <asp:RadioButton ID="rdSalaryandOTSheetByBank"  runat="server" Text="Salary & OT(Bank)" GroupName="rpt_Attend" />
                                    <br />
                                    <asp:RadioButton ID="rdSalaryandOTSheetByMobileBank"  runat="server" Text="Salary & OT(Mobile Bank)" GroupName="rpt_Attend" />
                                    <br />                                                            
                                    <%--<asp:RadioButton ID="rdSalaryTopSheet_Compliance" runat="server" Text="Salary Top Sheet" GroupName="rpt_Attend" />
                                    <br />
                                    <asp:RadioButton ID="rdSalaryTopSheetByCash_Compliance" runat="server" Text="Salary Top Sheet (Cash)" GroupName="rpt_Attend"/>
                                    <br />
                                    <asp:RadioButton ID="rdSalaryTopSheetByBank_Compliance" runat="server" Text="Salary Top Sheet (Bank)" GroupName="rpt_Attend"/>
                                    <br />
                                    <asp:RadioButton ID="rdSalaryTopSheetByMobileBank_Compliance" runat="server" Text="Salary Top Sheet (Mobile Bank)" GroupName="rpt_Attend"/>
                                    <br />--%>
                                    <%--<asp:RadioButton ID="rdOtSheet_Compliance" runat="server" Text="OT Sheet" GroupName="rpt_Attend"/>--%>
                                    <%--<br />--%>
