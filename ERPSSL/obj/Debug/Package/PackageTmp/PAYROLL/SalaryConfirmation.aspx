<%@ Page Title="" Language="C#" MasterPageFile="~/PAYROLL/Site.Master" AutoEventWireup="true"
    CodeBehind="SalaryConfirmation.aspx.cs" Inherits="ERPSSL.PAYROLL.SalaryConfirmation" %>
                ...
                <div class="hm_sec_2_content scrollbar">
                    <div class="panel">
                        <div class="panel-heading panel-heading-01">
                            <i class="glyphicon glyphicon-edit icon-padding"></i>Salary Confirmation
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="btn btn-primary" Style="margin-right: 5px;" OnClick="btnSearch_Click" />
                                            <asp:Button ID="bthHeldup" runat="server" Text="Held Up" ValidationGroup="Group1" Style="margin-right: 5px;"
                                            class="btn btn-danger " OnClick="bthHeldup_Click" />
                                        <asp:Button ID="BtnSave" runat="server" Text="Confirm"  ValidationGroup="Group1"
                    ...
                    <div class="col-md-12">
                        <fieldset>
                            <legend style="line-height: 0; margin-bottom: 0;"><span style="background: #fff">Processed Salary List</span></legend>
                                ...
                                <Columns>
                                   ...
                                   <%-- <asp:BoundField DataField="CONVEYANCE" HeaderText="Conveyance" DataFormatString="{0:0.00}">
                                    ...
                                    <asp:TemplateField ItemStyle-Width="2%" HeaderText="Held Up" ItemStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            <asp:CheckBox ID="rowheldupCheckBox" runat="server" />
                                            <headerstyle verticalalign="Middle" cssclass="Grid_Header" />
                                            <itemstyle horizontalalign="Center" cssclass="Grid_Border" />
                                            <footerstyle cssclass="Grid_Footer" />
                                        </ItemTemplate>
