<%@ Page Title="" Language="C#" MasterPageFile="~/POS/Site.Master" AutoEventWireup="true" CodeBehind="ItemSetup.aspx.cs" Inherits="ERPSSL.POS.ItemSetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
     <div class="hm_sec_2_content scrollbar">
         <div class="panel">
                    <div class="panel-heading panel-heading-01">
                        <i class="glyphicon glyphicon-edit icon-padding"></i>Ticket Setup
                    </div>
                </div> 
    <div class="row">
        ...
        <div class="box col-md-12">
            <div class="box-inner">
                ...
                <div class="box-content row " id="content-1">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row" style="margin: 0 8px;">
                            <asp:GridView ID="GridViewItem" runat="server" ShowFooter="True" Width="100%" DataKeyNames="Id"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Ticket Name">
                                    ...
                                    <asp:TemplateField HeaderText="Description">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtDescription" runat="server" Text='<%# Bind("Description") %>' CssClass=""
                                                MaxLength="30" Width="85%"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                        ...
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtDescription" runat="server" CssClass="" MaxLength="30" Width="85%"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredField21" runat="server" ControlToValidate="txtDescription"
                                                Display="Dynamic" ErrorMessage="Description is required!" ForeColor="Red" SetFocusOnError="True"
                                                ValidationGroup="newGrpSubSec"></asp:RequiredFieldValidator>
                                        </FooterTemplate>
                                        <HeaderStyle Width="20%" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Option">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkEdit" runat="server" Text="" CommandName="Edit" ToolTip="Edit"
                                                CommandArgument=''><img src="~/img/edit.jpg" width="28" height="28" runat="server" /></asp:LinkButton>
                                            <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete"
                                                ToolTip="Delete" OnClientClick='return confirm("Are you sure you want to delete this entry?");'
                                                CommandArgument=''><img src="~/img/remove.png" runat="server" /></asp:LinkButton>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:LinkButton ID="lnkInsert" runat="server" Text="" ValidationGroup="editGrp3"
                                                CommandName="Update" ToolTip="Save" CommandArgument=''><img src="~/img/save.png" runat="server" /></asp:LinkButton>
                                            <asp:LinkButton ID="lnkCancel" runat="server" Text="" CommandName="Cancel" ToolTip="Cancel"
                                                CommandArgument=''><img src="~/img/cancle.png" runat="server" /></asp:LinkButton>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:LinkButton ID="lnkInsert" runat="server" Text="" ValidationGroup="newGrpSubSec"
                                                CommandName="InsertNewItem" ToolTip="Add New Entry" CommandArgument=''><img src="~/img/add.png" runat="server" /></asp:LinkButton>
                                            <asp:LinkButton ID="lnkCancel" runat="server" Text="" CommandName="Cancel" ToolTip="Cancel"
                                                CommandArgument=''><img src="~/img/cancle.png" runat="server" /></asp:LinkButton>
                                        </FooterTemplate>
    ...
    <script>
        ...
        function func(result) {
            ...
            else if (result === 'Ticket Deleted successfully!') {
                toastr.success(result);
            }
            else
                toastr.error(result);
