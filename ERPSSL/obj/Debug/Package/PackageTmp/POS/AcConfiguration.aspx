<%@ Page Title="" Language="C#" MasterPageFile="~/POS/Site.Master" AutoEventWireup="true" CodeBehind="AcConfiguration.aspx.cs" Inherits="ERPSSL.POS.AcConfiguration" %>
                ...
                <div class="hm_sec_2_content scrollbar">
                    <div class="panel">
                        <div class="panel-heading panel-heading-01">
                            <i class="fa fa-edit fa-fw icon-padding"></i>Sales Summary
                        </div>
                    </div>
                    <asp:DropDownList ID="ddlSalestype" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlSalestype_SelectedIndexChanged" Width="250px" Height="28">
                    ...
                    <div style="height: 270px; overflow: scroll;">
                        <asp:GridView ID="dgListSales" runat="server" AutoGenerateColumns="False" Width="100%"
                            ...
                            <Columns>
                                <asp:BoundField DataField="SalesDate" HeaderText="Sale Date" DataFormatString="{0:d}">
                                    <HeaderStyle VerticalAlign="Middle" CssClass="Grid_Header" />
                                    <ItemStyle HorizontalAlign="Left" Width="10%" CssClass="Grid_Border" />
                                    <FooterStyle CssClass="Grid_Footer" />
                                </asp:BoundField>

                                <asp:BoundField DataField="EditUser" HeaderText="User Id">
                                    <HeaderStyle VerticalAlign="Middle" CssClass="Grid_Header" />
                                    <ItemStyle HorizontalAlign="Left" Width="40%" CssClass="Grid_Border" />
                                    <FooterStyle CssClass="Grid_Footer" />
                                </asp:BoundField>
                                ...
                                <asp:BoundField DataField="ItemTotal" HeaderText="Sale Total">
                                    <HeaderStyle VerticalAlign="Middle" CssClass="Grid_Header" />
                                    <ItemStyle HorizontalAlign="Left" Width="20%" CssClass="Grid_Border" />
                                    <FooterStyle CssClass="Grid_Footer" />
                                </asp:BoundField>
                    ...
                    <asp:Button ID="btnSync" runat="server" Text="Post Sale" class="btn btn-danger" OnClick="btnSync_Click" />
                </div>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
