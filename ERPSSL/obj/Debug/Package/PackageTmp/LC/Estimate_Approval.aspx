<%@ Page Title="" Language="C#" MasterPageFile="~/LC/Site.Master" AutoEventWireup="true" CodeBehind="Estimate_Approval.aspx.cs" Inherits="ERPSSL.LC.Estimate_Approval" %>
                ...
                <div class="hm_sec_2_content scrollbar">
                    <div class="panel">
                        <div class="panel-heading panel-heading-01">
                            <i class="glyphicon glyphicon-edit icon-padding"></i>Estimate Approval
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="panel panel-info">
                                            ...
                                            <legend style="line-height: 0px; padding-top: 5px;"><span style="background: #fff">Estimated List</span></legend>--%>
                                                <asp:GridView ID="grvEstimatedSummary" runat="server" AutoGenerateColumns="False" Width="100%" OnRowCommand="gridBackToBack_RowCommand"
                                                    CellPadding="4" BackColor="White" BorderColor="#336666" BorderStyle="Solid" OnPageIndexChanging="grvEstimatedSummary_PageIndexChanging"
                            ...
                            <div class="row" style="padding-top: 8px;">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <asp:Button ID="btnProcess" runat="server" Text="Approve" class="btn btn-info pull-right" OnClick="btnProcess_Click" />
                                    </div>
                                     <div class="col-md-4">
