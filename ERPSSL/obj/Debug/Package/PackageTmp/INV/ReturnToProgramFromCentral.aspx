<%@ Page Title="" Language="C#" MasterPageFile="~/INV/Site.Master" AutoEventWireup="true" CodeBehind="ReturnToProgramFromCentral.aspx.cs" Inherits="ERPSSL.INV.ReturnToProgramFromCentral" %>
                ...
                <div class="hm_sec_2_content scrollbar">
                    <div class="panel">
                        <div class="panel-heading panel-heading-01">
                            <i class="glyphicon glyphicon-edit icon-padding"></i>Return To Central Store
                        </div>
                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6">                                     
                                     ...
                                     <div class="row" style="padding-bottom: 8px">
                                        <div class="col-md-12">
                                            <div class="col-md-4">
                                               Central Store<a style="color: red; font-size: 11px">*</a>
                                            </div>
                                            <div class="col-md-8">
                                                <asp:DropDownList ID="ddlStoreName" AutoPostBack="true" CssClass="form-control" runat="server"                                                
                                    ...
                                    <div class="row" style="padding-bottom: 8px">
                                        <div class="col-md-12">
                                            <div class="col-md-4">
                                                Program<a style="color: red; font-size: 11px">*</a>
                                            </div>
                                            <div class="col-md-8">
                                               <asp:TextBox ID="txtChalanNoReturn" CssClass="form-control" runat="server" ReadOnly="True" Visible="false"></asp:TextBox>
                                                <asp:DropDownList ID="ddlProgram" AutoPostBack="true" CssClass="form-control" runat="server"
                                                    OnSelectedIndexChanged="ddlStore_SelectedIndexChanged">
                                                </asp:DropDownList>
                                  ...
                                  <%--  <div class="row" style="padding-bottom: 8px">
                                    ...
                                    <div class="row" style="padding-bottom: 8px;">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-8">
                                                <asp:DropDownList ID="ddlProductGroup" AutoPostBack="true" CssClass="form-control" Visible="false"
                                    ...
                                    <div class="row" style="padding-bottom: 8px">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-8">
                                                <asp:DropDownList ID="ddlProduct" AutoPostBack="true" CssClass="form-control" runat="server" Visible="false"
