<%@ Page Title="" Language="C#" MasterPageFile="~/INV/Site.Master" AutoEventWireup="true"
    CodeBehind="HeadApproval.aspx.cs" Inherits="ERPSSL.INV.HeadApproval" %>
            ...
            <div class="row">
                ...
                <div class="hm_sec_2_content scrollbar">
                    ...
                    <div class="panel-heading panel-heading-01">
                        <i class="glyphicon glyphicon-edit icon-padding"></i>Admin Approval
                    </div>
                </div>
                                    ...
                                    <fieldset style="border: none">
                                        <asp:GridView ID="grdRequisition" runat="server" AutoGenerateColumns="False" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="DesiredRcvDate" HeaderText="Exp. Date" DataFormatString="{0:dd/MM/yyyy}" SortExpression="DesiredRcvDate">
                                                ...
                                                <asp:BoundField DataField="CompanyType" HeaderText="Company Type" SortExpression="CompanyType"
                                                    Visible="false"></asp:BoundField>
                                                <asp:BoundField DataField="DPT_NAME" HeaderText="Dept." SortExpression="DPT_NAME">
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:BoundField>
