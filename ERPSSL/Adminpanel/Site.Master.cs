    ...
    public partial class Site : System.Web.UI.MasterPage
    {
          ...
          GetModulS();
            ...
            else
            {
               ...
               // GetPageByModulId(ModuleId);
                ...
                // <!-- Modified on 11-04-2016 BY Abdul Alim -->  

                var role = ((SessionUser)Session["SessionUser"]).RoleId;
                if (role == "6")
                {
                    Module.Visible = true;
                    aPage.Visible = true;
        ...
        private void GetLoginImage()
        {
            try
            {
                ...
                Image2.ImageUrl = "../HRM/EmployeeIMG.ashx?eId=" + eid + "&oCode=" + OCODE;
            }
            catch (Exception)
            {
                throw;
        ...
        //    {
        //        List<Category> categories = pageObj.GetCategoryByModulId(ModuleId, Ocode).ToList();
        //        if (categorys.Count > 0)
        //        {

        //            reptManuList.DataSource = categories;
        ...
        //        List<Category> categories = pageObj.GetCategoryForUserByModulId(ModuleId, Ocode, use).ToList();
        //        if (categorys.Count > 0)
        //        {
