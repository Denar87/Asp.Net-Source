    ...
    public partial class PaymentVoucher : System.Web.UI.Page
    {
        ...
        private void BindListData()
        {
            try
            {
                ...
                dtg_ACT.DataSource = Session["entries_pv"];
                dtg_ACT.DataBind();
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                if ((Session["CompanyCode"] != null) && (Session["OCode"] != null))
                {
                    ...
                    if (Session["LedgerCode"] != null)
                    {
                        ...
                        Session["entries_pv"] = objVch_List;
        ...
        private void SaveVoucher()
        {
            try
            {
                ...
                ht.Add("VoucherType", VoucherType);
                ht.Add("Voucher_Total", Convert.ToDouble(Session["dGTotal_pv"]));
                ...
                var myList = (List<Listvch_Details>)Session["entries_pv"];
                ...
                if (status == true)
                {
                    ...
                    cGTotal = 0;
                    dGTotal = 0;
                    Session["entries_pv"] = null;
                    Session["dGTotal_pv"] = null;
                    Session["cGTotal_pv"] = null;
                    messagePanel.Visible = true;
        ...
        private bool IsValid()
        {
            try
            {
                if ((Convert.ToDouble(Session["dGTotal_pv"]) == 0) && (Convert.ToDouble(Session["cGTotal_pv"]) == 0))
                {
                    messagePanel.Visible = true;
                ...
                if ((Convert.ToDouble(Session["dGTotal_pv"]) != Convert.ToDouble(Session["cGTotal_pv"])))
                {
                    messagePanel.Visible = true;
        ...
        private void GrandTotal_Dr()
        {
            try
            {
                ...
                for (int i = 0; i < dtg_ACT.Rows.Count; i++)
                {
                    ...
                    Session["dGTotal_pv"] = dGTotal.ToString();
                }
                txtdbtTotal.Text = "Dr." + Session["dGTotal_pv"].ToString();
            }
            catch (Exception ex)
            {
                this.messagePanel.Visible = true;
        ...
        private void GrandTotal_Cr()
        {
            try
            {
                ...
                for (int i = 0; i < dtg_ACT.Rows.Count; i++)
                {
                    ...
                    Session["cGTotal_pv"] = cGTotal.ToString();
                }
                txtCrdTotal.Text = "Cr." + Session["cGTotal_pv"].ToString();
            }
            catch (Exception ex)
            {
                this.messagePanel.Visible = true;
