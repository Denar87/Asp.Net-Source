<%@ Page Title="" Language="C#" MasterPageFile="~/Accounting/Site.Master" AutoEventWireup="true"
    CodeBehind="ContraVoucher.aspx.cs" Inherits="ERPSSL.Accounting.UI_Voucher.ContraVoucher" 
                ...
                <ContentTemplate>
                    <div class="widget-box">
                        <div class="widget-header">
                            <h5 class="widget-title bigger lighter" style="color: #258dc8;">
                                <i class="ace-icon fa fa-table"></i>Contra Voucher
                            </h5>
                            <ul class="VoucherPanel" style="margin-right: 40px">
                                <li>
                                    <label class="control-label" for="inputFname1">
                                        Voucher No:
                                <asp:TextBox ID="txtVoucherNo" runat="server" Width="150px" Enabled="False" BackColor="#258dc8" ForeColor="White">
                                </asp:TextBox>
                                    </label>
                                </li>
                                <li>
                                    <label class="control-label" for="inputFname1">
                                        Voucher Date:
                                <asp:TextBox ID="dtpVoucherDate" runat="server" placeholder="MM/dd/yyyy" Width="100px" BackColor="#258dc8" ForeColor="White">
                                </asp:TextBox>
                                            ...
                                            <asp:GridView ID="dtg_ACT" runat="server" CellPadding="5" AutoGenerateColumns="false" Width="100%"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Sr.">
                                                        ...
                                                        <HeaderStyle VerticalAlign="Middle" CssClass="Grid_Header Color_Blue" Width="30px" />
                                                        <ItemStyle HorizontalAlign="Left" Width="30px" CssClass="Grid_Border" />
                                                        <FooterStyle CssClass="Grid_Footer Color_Blue" Width="30px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Nature">
                                                        ...
                                                        <HeaderStyle VerticalAlign="Middle" CssClass="Grid_Header Color_Blue" Width="80px" />
                                                        <ItemStyle HorizontalAlign="Left" Width="80px" CssClass="Grid_Border" />
                                                        <FooterStyle CssClass="Grid_Footer Color_Blue" Width="80px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Particulars">
                                                        ...
                                                        <HeaderStyle VerticalAlign="Middle" CssClass="Grid_Header Color_Blue" Width="250px" />
                                                        <ItemStyle HorizontalAlign="Left" CssClass="Grid_Border" Width="250px" />
                                                        <FooterStyle CssClass="Grid_Footer Color_Blue" Width="250px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Cheque No">
                                                        ...
                                                        <HeaderStyle VerticalAlign="Middle" CssClass="Grid_Header Color_Blue" Width="150px" />
                                                        <ItemStyle HorizontalAlign="Left" CssClass="Grid_Border" Width="150px" />
                                                        <FooterStyle CssClass="Grid_Footer Color_Blue" Width="150px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Dr.">
                                                        ...
                                                        <HeaderStyle VerticalAlign="Middle" CssClass="Grid_Header Color_Blue" Width="100px" />
                                                        <ItemStyle HorizontalAlign="Right" CssClass="Grid_Border" Width="100px" />
                                                        <FooterStyle CssClass="Grid_Footer Color_Blue" Width="100px" />
                                                    </asp:TemplateField>
                                                ...
                                                <EmptyDataTemplate>
                                                    <tr class="Grid_Header Color_Blue">
                                                        <th scope="col">Nature
                                                        </th>
                                                    ...
                                                    <tr class="Grid_Footer Color_Blue">
                                                        <td>
