    ...
    public partial class ReceiptVoucher : System.Web.UI.Page
    {
        ...
        private void BindListData()
        {
            try
            {
                ...
                dtg_ACT.DataSource = Session["entries_rv"];
                dtg_ACT.DataBind();
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                if ((Session["CompanyCode"] != null) && (Session["OCode"] != null))
                {
                    ...
                    if (Session["LedgerCode"] != null)
                    {
                        ...
                        Session["entries_rv"] = objVch_List;
        ...
        private void SaveVoucher()
        {
            try
            {
                ...
                ht.Add("VoucherType", VoucherType);
                ht.Add("Voucher_Total", Convert.ToDouble(Session["dGTotal_rv"]));
                ...
                var myList = (List<Listvch_Details>)Session["entries_rv"];
                ...
                if (status == true)
                {
                    ...
                    Session["dGTotal_rv"] = null;
                    Session["cGTotal_rv"] = null;
                    messagePanel.Visible = true;
        ...
        private bool IsValid()
        {
            try
            {
                if ((Convert.ToDouble(Session["dGTotal_rv"]) == 0) && (Convert.ToDouble(Session["cGTotal_rv"]) == 0))
                {
                    messagePanel.Visible = true;
                ...
                if ((Convert.ToDouble(Session["dGTotal_rv"]) != Convert.ToDouble(Session["cGTotal_rv"])))
                {
                    messagePanel.Visible = true;
        ...
        private void GrandTotal_Dr()
        {
            try
            {
                ...
                for (int i = 0; i < dtg_ACT.Rows.Count; i++)
                {
                    ...
                    Session["dGTotal_rv"] = dGTotal.ToString();
                }
                txtdbtTotal.Text = "Dr." + Session["dGTotal_rv"].ToString();
            }
            catch (Exception ex)
            {
                this.messagePanel.Visible = true;
        ...
        private void GrandTotal_Cr()
        {
            try
            {
                ...
                for (int i = 0; i < dtg_ACT.Rows.Count; i++)
                {
                    ...
                    Session["cGTotal_rv"] = cGTotal.ToString();
                }
                txtCrdTotal.Text = "Cr." + Session["cGTotal_rv"].ToString();
            }
            catch (Exception ex)
            {
                this.messagePanel.Visible = true;
