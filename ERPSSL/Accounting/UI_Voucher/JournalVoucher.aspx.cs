    ...
    public partial class JournalVoucher : System.Web.UI.Page
    {
        ...
        private void BindListData()
        {
            try
            {
                ...
                dtg_ACT.DataSource = Session["entries_jv"];
                dtg_ACT.DataBind();
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                if ((Session["CompanyCode"] != null) && (Session["OCode"] != null))
                {
                    ...
                    if (Session["LedgerCode"] != null)
                    {
                        ...
                        Session["entries_jv"] = objVch_List;
        ...
        private void SaveVoucher()
        {
            try
            {
                ...
                ht.Add("VoucherType", VoucherType);
                ht.Add("Voucher_Total", Convert.ToDouble(Session["dGTotal_jv"]));
                ...
                var myList = (List<Listvch_Details>)Session["entries_jv"];
                ...
                if (status == true)
                {
                    ...
                    cGTotal = 0;
                    dGTotal = 0;
                    Session["entries_jv"] = null;
                    Session["dGTotal_jv"] = null;
                    Session["cGTotal_jv"] = null;
                    messagePanel.Visible = true;
        ...
        private bool IsValid()
        {
            try
            {
                if ((Convert.ToDouble(Session["dGTotal_jv"]) == 0) && (Convert.ToDouble(Session["cGTotal_jv"]) == 0))
                {
                    messagePanel.Visible = true;
                ...
                if ((Convert.ToDouble(Session["dGTotal_jv"]) != Convert.ToDouble(Session["cGTotal_jv"])))
                {
                    messagePanel.Visible = true;
        ...
        private void GrandTotal_Dr()
        {
            try
            {
                ...
                for (int i = 0; i < dtg_ACT.Rows.Count; i++)
                {
                    ...
                    Session["dGTotal_jv"] = dGTotal.ToString();
                }
                txtdbtTotal.Text = "Dr." + Session["dGTotal_jv"].ToString();
            }
            catch (Exception ex)
            {
                this.messagePanel.Visible = true;
        ...
        private void GrandTotal_Cr()
        {
            try
            {
                ...
                for (int i = 0; i < dtg_ACT.Rows.Count; i++)
                {
                    ...
                    Session["cGTotal_jv"] = cGTotal.ToString();
                }
                txtCrdTotal.Text = "Cr." + Session["cGTotal_jv"].ToString();
            }
            catch (Exception ex)
            {
                this.messagePanel.Visible = true;
