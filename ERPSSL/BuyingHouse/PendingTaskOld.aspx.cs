...
{
    public partial class PendingTaskOld : System.Web.UI.Page
    {
        ...
        {
            List<LC_OrderEntry> ordels = new List<LC_OrderEntry>();
            ...
            try
            {
                ...
                List<OrderUpdateRepository> orders = masterBLL.GetOrderByOrderNoandOcode(orderNo, OCODE);

                if (orders.Count > 0)
                {
                    foreach (OrderUpdateRepository order in orders)
                    {
