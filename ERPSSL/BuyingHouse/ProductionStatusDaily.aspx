<%@ Page Title="" Language="C#" MasterPageFile="~/BuyingHouse/BuyingSite.Master" AutoEventWireup="true" CodeBehind="ProductionStatusDaily.aspx.cs" Inherits="ERPSSL.BuyingHouse.ProductionStatusDaily" %>
        ...
        <div class="hm_sec_2_content scrollbar">
            <div class="panel">
                <div class="panel-heading panel-heading-01">
                    <i class="glyphicon glyphicon-edit icon-padding"></i>Production Status Daily
                </div>
            </div>
            ...
            <div class="col-md-12" style="margin: auto 0;">
                ...
                <div class="row" style="margin-top: 5px;">
                    <div class="col-md-12" style="height: auto; padding-left: 0;">
                        <asp:GridView ID="GridViewItem" runat="server" ShowFooter="True" Width="100%" DataKeyNames="ProductionProcces_Id"
                            ...
                            OnRowUpdating="GridViewItem_RowUpdating" OnRowDataBound="GridViewItem_RowDataBound">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="2%" HeaderStyle-HorizontalAlign="Center" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblID" runat="server"
                                            Text='<%# Bind("ProductionStatus_Id") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle Width="0%" />
                                </asp:TemplateField>

                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="2%" HeaderStyle-HorizontalAlign="Center" Visible="false" HeaderText="">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Production Process">
                                    <ItemTemplate>
                                        <asp:Label ID="lblProductionProcess" runat="server" Text='<%# Bind("ProductionProcess") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Schedule Date">
                                    <ItemTemplate>
                                        <asp:Label ID="lblSchedule_Date" runat="server" Text='<%# Bind("Schedule_Date","{0:MM/dd/yyyy}") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle Width="10%" />
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Daily Terget">
                                    <ItemTemplate>
                                        <asp:Label ID="lblDailyProduction" runat="server" Text='<%# Bind("DailyProduction", "{0:00.00}") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Production Date">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtProductionDate" runat="server" placeholder="MM/dd/yyyy" Text='<%# Bind("InputDate") %>' Height="100%" Width="100%"></asp:TextBox>
                                        <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtProductionDate"
                                            PopupButtonID="txtProductionDate" Format="MM/dd/yyyy" CssClass="ajax__calendar"
                                            Enabled="True" />
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblProductionDate" Text='<%# Bind("InputDate","{0:MM/dd/yyyy}") %>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle Width="10%" />
                                </asp:TemplateField>

                                <%----%>
                                <asp:TemplateField HeaderText="Day Input">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtDayInput" runat="server" AutoPostBack="true" Text='<%# Bind("DayInput") %>'
                                            OnTextChanged="txtDayInput_TextChanged" Height="100%" Width="100%"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblDayInput" Text='<%# Bind("DayInput") %>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle Width="7%" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Achievement %">
                                    <%----%>
                                    <ItemTemplate>
                                        <asp:Label ID="lblAchievementPercentage" Text='<%# Bind("AchievementPercentage") %>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle Width="9%" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Status">
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="ddlStatus" runat="server" Height="100%" Width="100%"></asp:DropDownList>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Resposible Person">
                                    ...
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="ddlResposiblePerson" runat="server" Height="100%" Width="100%"></asp:DropDownList>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblResposiblePerson" runat="server" Text='<%# Bind("Responsible_Person") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle Width="12%" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Comments">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtComments" runat="server" Text='<%# Bind("Comments") %>' Height="100%" Width="100%"></asp:TextBox>
                                ...
                                <asp:TemplateField HeaderText="Option" ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <EditItemTemplate>
                                        <asp:LinkButton ID="lnkUpdate" runat="server" Text="" ValidationGroup="editGrp3"
                                            ...
                                            <img id="Img3" src="~/img/save.png" style="width: 50%" runat="server" />
                                        </asp:LinkButton>
                                        <asp:LinkButton ID="lnkCancel" runat="server" Text="" CommandName="Cancel" ToolTip="Cancel"
                                            CommandArgument=''>
                                            <img id="Img4" src="~/img/cancle.png" style="width: 50%" runat="server" />
                                        </asp:LinkButton>
                                    </EditItemTemplate>
                ...
                <div class="col-md-12" style="max-height: 400px; height: auto; padding-top: 5px; padding-right: 0; margin: auto 0;">
                    <asp:Button ID="btnUpdate" runat="server" Text="Update" Visible="false" class="btn btn-info pull-right" ValidationGroup="Group1" OnClick="btnUpdate_Click" />
                </div>
            </div>
        </div>
    </div>
