<%@ Page Title="" Language="C#" MasterPageFile="~/BuyingHouse/BuyingSite.Master" AutoEventWireup="true"
    CodeBehind="section.aspx.cs" Inherits="ERPSSL.BuyingHouse.section" %>
...
<ContentTemplate>
    ...
    <div class="hm_sec_2_content scrollbar">
        ...
        <div class="panel-heading panel-heading-01">
            <i class="fa fa-edit fa-fw icon-padding"></i>Setup Section
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-5">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-7">
                            <asp:DropDownList ID="drpDepartment" class="form-control" runat="server"></asp:DropDownList>
                        </div>
                    </div>
                </div>
                <br />
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-7">
                            <asp:TextBox ID="txtbxSection" runat="server" class="form-control"></asp:TextBox>
            ...
            <div class="col-md-7">
                <asp:GridView ID="gridviewSection" runat="server" AutoGenerateColumns="False" Width="100%"
                    CellPadding="5" AllowPaging="True" PageSize="10" OnPageIndexChanging="gridviewSection_PageIndexChanging">
                    <Columns>
                        ...
                        <asp:BoundField DataField="SEC_NAME" HeaderText="Section Name">
                            <HeaderStyle VerticalAlign="Middle" CssClass="Grid_Header" />
                            <ItemStyle HorizontalAlign="Left" Width="15%" CssClass="Grid_Border" />
                            <FooterStyle CssClass="Grid_Footer" />
                        </asp:BoundField>
