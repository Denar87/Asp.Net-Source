...
namespace ERPSSL.BuyingHouse
{
    public partial class LC_Amend : System.Web.UI.Page
    {
        ...
        protected void txtLCAmend_USDValue_TextChanged(object sender, EventArgs e)
        {
            try
            {
                double USD_LCValue = Convert.ToDouble(txtUSDV.Text);
                ...
                Session["TotalAmend_USDValue"] = txtTotalAmend_USDValue.Text;
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        protected void txtLCAmend_BDTValue_TextChanged(object sender, EventArgs e)
        {
            try
            {
                double BDT_LCValue = Convert.ToDouble(txtBDTV.Text);
                ...
                Session["TotalAmend_BDTValue"] = txtTotalAmend_BDTValue.Text;
            }
            catch (Exception ex)
            {
                throw ex;
