<%@ Page Title="" Language="C#" MasterPageFile="~/BuyingHouse/BuyingSite.Master" AutoEventWireup="true" CodeBehind="ProductionPlanning.aspx.cs" Inherits="ERPSSL.BuyingHouse.ProductionPlanning" %>
        ...
        <div class="hm_sec_2_content scrollbar">
            <div class="panel">
                <div class="panel-heading panel-heading-01">
                    <i class="glyphicon glyphicon-edit icon-padding"></i>Production Planning
                </div>
            </div>
            ...
            <div class="col-md-12" style="margin: auto 0;">
                    ...
                    <div class="col-md-12" style="height: auto; padding: 0;">
                        <asp:GridView ID="GridViewItem" runat="server" ShowFooter="True" Width="100%" DataKeyNames="ProductionProcces_Id"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="2%" HeaderStyle-HorizontalAlign="Center" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblID" runat="server"
                                            Text='<%# Bind("ProductionProcces_Id") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle Width="0%" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="P. Terget">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtTergetQty" runat="server" Text='<%# Bind("TergetQty") %>' CssClass="form-control"
                                            MaxLength="30" Width="100%"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblTergetQty" runat="server" Text='<%# Bind("TergetQty") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle Width="8%" />
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Terget Line">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtTergetLine" runat="server" AutoPostBack="true" OnTextChanged="txtTergetLine_TextChanged"
                                            CssClass="form-control" MaxLength="30" Width="100%"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblTergetLine" runat="server" Text='<%# Bind("TergetLine") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Daily Production">
                                    <ItemTemplate>
                                        <asp:Label ID="lblDailyProduction" runat="server" Text='<%# Bind("DailyProduction","{0:0.00}") %>'></asp:Label>
                                    </ItemTemplate>
                ...
                <div class="col-md-12" style="padding: 0; padding-left: 5px; padding-top: 5px;">
