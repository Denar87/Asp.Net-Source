<%@ Page Title="" Language="C#" MasterPageFile="~/BuyingHouse/BuyingSite.Master" AutoEventWireup="true" CodeBehind="ShipmentDateWiseOrderList.aspx.cs" Inherits="ERPSSL.BuyingHouse.ShipmentDateWiseOrderList" %>
                            ...
                            <asp:GridView ID="grdorder" runat="server" AutoGenerateColumns="False" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField Visible="False">
                                      ...
                                      <asp:TemplateField Visible="False">
                                        <ItemTemplate>
                                            <asp:Label ID="lblOrder_No" runat="server" Text='<%# Eval("OrderNo")%>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                  ...
                                  <%--  <asp:BoundField DataField="ColorSpecification" HeaderText="Color/Specification">
                                    ...
                                    <asp:BoundField DataField="OrderQuantity" HeaderText="Order Qty">
                                     ...
                                     <asp:BoundField DataField="FobQty" HeaderText="FobQty">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
