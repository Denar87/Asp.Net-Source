<%@ Page Title="" Language="C#" MasterPageFile="~/LC/Site.Master" AutoEventWireup="true" CodeBehind="OrderEntryNew.aspx.cs" Inherits="ERPSSL.LC.OrderEntryNew" %>
                                        ...
                                        <div class="row" runat="server" id="OrderNo1">
                                            ...
                                            <div>
                                                <div class="col-md-12" style="padding: 0px;">
                                                    ...
                                                    <div class="col-md-1">
                                                        <asp:CheckBox ID="chkNewstyle2" runat="server" Visible="true" AutoPostBack="True" OnCheckedChanged="ChkStyle2_CheckedChanged"></asp:CheckBox>
                                                    </div>
