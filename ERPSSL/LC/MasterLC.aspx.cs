...
namespace ERPSSL.LC
{
    public partial class MasterLC : System.Web.UI.Page
    {
        ...
        private void ShowMasterLC()
        {
            try
            {
                ...
                List<LC_MasterLC> lcload = _masterlcBLL.GetALLLCByType(OCode);
                if (lcload.Count > 0)
                {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (ddlSubCompany.SelectedItem.Text != "---Select One---")
                {
                    ...
                    //else
                    //{
                    //    _objLCmaster.SeasonId = Convert.ToInt32(ddlSeason.SelectedValue);
                    //} 
