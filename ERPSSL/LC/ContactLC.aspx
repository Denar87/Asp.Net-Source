<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactLC.aspx.cs" Inherits="ERPSSL.LC.ContactLC" MasterPageFile="~/LC/Site.Master" %>
                ...
                <div class="hm_sec_2_content scrollbar">
                    <div class="panel">
                        <div class="panel-heading panel-heading-01">
                            <i class="glyphicon glyphicon-edit icon-padding"></i>Contract LC
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row" style="padding-top: 5px"  runat="server" visible="false">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:DropDownList ID="ddlSeason" runat="server" Width="110%" class="form-control"></asp:DropDownList>
