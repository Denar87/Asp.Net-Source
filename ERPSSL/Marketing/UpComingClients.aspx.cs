...
{
    public partial class UpComingClients : System.Web.UI.Page
    {
        ...
        {
            List<MarketingProjectStage> aUpcomingOrderList = aMarketingInfoBLL.GetUpcomingOrderList();

            grdorder.DataSource = aUpcomingOrderList;
            grdorder.DataBind();
        }
        ...
        protected void imgbtnOrderSheetEdit_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("ViewUpcomingClients.aspx");
        }
    }
}