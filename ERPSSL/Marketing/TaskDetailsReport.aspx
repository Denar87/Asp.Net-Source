<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/Marketing.Master" AutoEventWireup="true" CodeBehind="TaskDetailsReport.aspx.cs" Inherits="ERPSSL.Marketing.TaskDetailsReport" %>
        ...
        <ContentTemplate>
            ...
            <div class="row">
                <div class="hm_sec_2_content scrollbar">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                               ...
                               <%-- <div id="div1" class="row">
                                ...
                                <div class="row">
                                     <div class="col-md-6">
                                        <asp:Label ID="lblMarketingPersonOrStage" runat="server">Select Client</asp:Label>
                                        <asp:DropDownList ID="clientDropDownList" AppendDataBoundItems="True" CssClass="form-control" runat="server">
                                        </asp:DropDownList>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <asp:RadioButton ID="searchRadioButton" runat="server" Text="Search All" GroupName="rpt_Prod" AutoPostBack="True" Checked="True" OnCheckedChanged="searchRadioButton_CheckedChanged" /><br />
                                    <asp:RadioButton ID="clientNameRadioButton" runat="server"  Text="Client List" GroupName="rpt_Prod" AutoPostBack="True" OnCheckedChanged="clientNameRadioButton_CheckedChanged" /><br />
                                </fieldset>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <%-- Report Viewer Here --%>
                        <rsweb:ReportViewer ID="taskDetailsReportViewer" style="width:1050px;" runat="server"></rsweb:ReportViewer>
