...
{
    public partial class PrimaryClients : System.Web.UI.Page
    {
        ...
        {
            List<MarketingProjectStage> aPromaryClientList = aMarketingInfoBLL.GetUpPrimaryClientList();

            grdorder.DataSource = aPromaryClientList;
            grdorder.DataBind();
        }
        ...
        protected void imgbtnOrderSheetEdit_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("ViewPrimaryClient.aspx");
        }
