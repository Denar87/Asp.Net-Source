<%@ Page Title="" Language="C#" MasterPageFile="~/Merchandising/Merchandising.Master" AutoEventWireup="true" CodeBehind="OrderDetailsReport.aspx.cs" Inherits="ERPSSL.Merchandising.OrderDetailsReport" %>
            ...
            <div class="row">
                <div class="hm_sec_2_content scrollbar">
                    ...
                    <div class="col-md-12">
                        ...
                        <rsweb:ReportViewer ID="ReportViewerOrderDetails" Width="800px" style="width:1050px;" runat="server"></rsweb:ReportViewer>
                    </div>
                </div>
