<%@ Page Title="" Language="C#" MasterPageFile="~/Merchandising/Merchandising.Master" AutoEventWireup="true" CodeBehind="ConstructionType.aspx.cs" Inherits="ERPSSL.Merchandising.ConstructionType" %>
                    ...
                    <div class="row" style="margin: auto 0;">
                        ...
                        <div class="col-md-5" style="margin: auto 0;">
                            <div class="row" style="padding-top: 5px;">
                                ...
                                <div class="col-md-7">
                                    <asp:TextBox ID="constructionTypeTextBox" runat="server" placeholder="Construction Type" class="form-control"></asp:TextBox>
                                </div>    
                        ...
                        <asp:HiddenField ID="constructionTypeHiddenField" runat="server" />
                        <div class="col-md-7" style="padding-top: 5px;">
                            <asp:GridView ID="constructionTypeInfo" runat="server" AutoGenerateColumns="False" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ConstructionType" HeaderText="Construction Type" />
