<%@ Page Title="" Language="C#" MasterPageFile="~/FA/Site.Master" AutoEventWireup="true"
    CodeBehind="OverallAccountingEntry_RPT.aspx.cs" Inherits="ERPSSL.FA.OverallAccountingEntry_RPT" %>
    ...
    <div class="row">
        ...
        <div class="panel">
            <div class="panel-heading panel-heading-01">
                <i class="fa fa-edit fa-fw icon-padding"></i>Overall Accounting Entry Report
            </div>
        </div>
                ...
                <fieldset style="border: none;">
                    <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtDateTo"
                                            PopupButtonID="txtDateTo" Format="MM/dd/yyyy" CssClass="ajax__calendar" Enabled="True" />
                                    </div>
                                </div>
                            </div>
                            <br />
                        ...
                        <div class="col-md-6">
                            <div class="col-md-12">
                                <fieldset>
                                    <legend style="line-height: 0;"><span style="background: #fff">Report Type </span>
                                    </legend>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <asp:RadioButtonList ID="rdoBy" runat="server">
                                                <asp:ListItem Selected="True" Value="ByIndividualAsset">By Individual Asset</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </div>
                                    </div>
                                    <br />
                            ...
                            <div class="row ">
                                <div class="col-md-12">
                                    <asp:HiddenField ID="hdfAccountingEntry" runat="server" />
