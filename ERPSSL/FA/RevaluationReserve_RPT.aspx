<%@ Page Title="" Language="C#" MasterPageFile="~/FA/Site.Master" AutoEventWireup="true" CodeBehind="RevaluationReserve_RPT.aspx.cs" Inherits="ERPSSL.FA.RevaluationReserve_RPT" %>
        ...
        <div class="hm_sec_2_content scrollbar">
            <div class="panel">
                <div class="panel-heading panel-heading-01">
                    <i class="fa fa-edit fa-fw icon-padding"></i>Revaluation Reserve Report
                </div>
            </div>
                ...
                <fieldset style="border: none;">
                    <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <ajaxToolkit:CalendarExtender ID="txtDateFrom_CalendarExtender" runat="server" TargetControlID="txtDateFrom"
                                            PopupButtonID="txtDateFrom" Format="MM/dd/yyyy" CssClass="ajax__calendar"
                                            Enabled="True" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtDateTo"
                                            PopupButtonID="txtDateTo" Format="MM/dd/yyyy" CssClass="ajax__calendar"
                                            Enabled="True" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row ">
                                <div class="col-md-12">
                                    <asp:HiddenField ID="hdfRevaluationReserve" runat="server" />
