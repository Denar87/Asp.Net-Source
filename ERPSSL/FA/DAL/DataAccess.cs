...
namespace SSL.FA.DAL
{
    public class DataAccess
    {
        ...
        private static string ConnectionString = ConfigurationManager.ConnectionStrings["SSLFixedAsset"].ConnectionString;
        ...
        public static DataSet GetDataSetByProc(Hashtable ht, string SProc)
        {
            con = new SqlConnection(ConnectionString);
            cmd = new SqlCommand();
        ...
        public static object GetScalar(string QueryString)
        {
            ...
            {
                con.Open();
                cmd = new SqlCommand(QueryString.Trim(), con);
        ...
        /// <summary>
        /// Get scalar value from database using dynamic sql query string
        /// <para>Use it when to get scalar value from database through inline sql query string. Please DO use parameterized sql query</para>
        /// </summary>
        /// <param name="htable">The hashtable containing key-value pairs of Sql parameters</param>
        /// <param name="QueryString">The query string</param>
        /// <returns>string</returns>
        /// 
        public static object GetScalar(Hashtable htable, string QueryString)
        {
            con = new SqlConnection(ConnectionString);
            cmd = new SqlCommand();
            ...
            try
            {
                ...
                {
                    string ColumnName = Convert.ToString(key);
                    SqlParameter param = new SqlParameter(ColumnName, htable[key]);
                    cmd.Parameters.Add(param);
                }
                //
                obj = cmd.ExecuteScalar();
